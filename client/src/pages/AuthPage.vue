            ...
            <div v-if="isLogin" key="login" class="auth-form-wrapper">
              ...
              <form @submit.prevent="handleLogin" class="auth-form">
                <div class="form-group">
                  ...
                  <input type="email" v-model="loginForm.email" class="input" required placeholder="Enter your email" />
                </div>
                
                <div class="form-group">
                  <label class="label">Password</label>
                  <div class="password-input-wrapper">
                    <input :type="showPassword ? 'text' : 'password'" v-model="loginForm.password" class="input" required placeholder="Enter your password" />
            ...
            <div v-else key="signup" class="auth-form-wrapper">
              ...
              <form @submit.prevent="handleSignup" class="auth-form">
                <div class="form-group">
                  ...
                  <input type="text" v-model="signupForm.name" class="input" required placeholder="John Doe" />
                </div>
                
                <div class="form-group">
                  <label class="label">Email Address</label>
                  <input type="email" v-model="signupForm.email" class="input" required placeholder="Enter your email" />
                </div>
                
                <div class="form-group">
                  <label class="label">Password</label>
                  <div class="password-input-wrapper">
                    <input :type="showPassword ? 'text' : 'password'" v-model="signupForm.password" class="input" required placeholder="Create a password" />
                    <button type="button" class="pwd-toggle" @click="showPassword = !showPassword">
                      {{ showPassword ? 'Hide' : 'Show' }}
                    </button>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input :type="showPassword ? 'text' : 'password'" v-model="signupForm.confirmPassword" class="input" required placeholder="Confirm your password" />
                </div>
